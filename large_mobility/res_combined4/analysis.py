...
if __name__ == "__main__":
    ...
    traj_stn = combined_data[combined_data["stations_per_cell"] == 5]
    traj_stn = traj_stn[traj_stn["delta_t_ratio_or_epsilon"] == 1] 
    traj_stn = traj_stn[traj_stn["spatial_simplification"] == "none"]
